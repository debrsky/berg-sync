...
блокировку запуска на этой машине: `%ProgramData%\berg-sync\run.lock`.
...
удалять не нужно. У пользователей, запускающих программу, должен быть доступ
на запись в этот общий каталог.
